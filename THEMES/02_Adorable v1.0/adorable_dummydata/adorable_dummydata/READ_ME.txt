...
How to Use the TXT(options_panel_settings_Adorable.txt) File to Import the Demo Options Panel settings

1. Log into your site as an administrator.
2. Make sure you activated your new theme before proceeding.
3. Go to Adorable → Import Export tab in the bottom left.
